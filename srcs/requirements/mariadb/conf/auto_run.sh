...
#mysql -e "CREATE USER IF NOT EXISTS '${SQL_USER}'@'bhennequ.42.fr' IDENTIFIED BY '${SQL_PASSWORD}';"
#mysql -e "GRANT ALL PRIVILEGES ON \`${SQL_DATABASE}\`.* TO '${SQL_USER}'@'%' IDENTIFIED BY '${SQL_PASSWORD}';"

mysql -e "CREATE DATABASE IF NOT EXISTS \`database1\`;"
mysql -e "CREATE USER IF NOT EXISTS 'user1'@'bhennequ.42.fr' IDENTIFIED BY 'mdpuser1';"
